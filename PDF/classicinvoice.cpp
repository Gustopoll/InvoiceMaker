#include "classicinvoice.h"
#include <QDebug>
#include <Extensions/typeinvoicemapper.h>

ClassicInvoice::ClassicInvoice(QString pathfile) : Invoice(pathfile)
{
}

ClassicInvoice::ClassicInvoice(QPainter *paint) : Invoice(paint)
{
}

void ClassicInvoice::Generate(InvoiceEntity *invoice)
{
...
ClassicInvoice::~ClassicInvoice()
{

}

void ClassicInvoice::SupplierGenerate(SupplierEntity *entity)
{
    painter->drawText(leftBorder,newLine(),"Faktúra číslo: " + QString::number(entity->getFactureNumberClassic()));
    newLine();
...
void ClassicInvoice::CustomerGenerate(CustomerEntity *entity)
{
...
void ClassicInvoice::OtherGenerate(InvoiceEntity *invoice)
{
    newLine();
    ...
    QString objednavky = QString::number(invoice->getSupplierSaved()->getFactureNumberClassic()) + "/" + invoice->getDateV().toString("yyyy");
